// Generated using https://react-svgr.com/playground/


//useful info about svgs & tailwindcss: https://stackoverflow.com/questions/64197107/how-to-modify-svg-icon-colors-with-tailwind
const GithubLogoSVG = (
    props: any
) => (
    <svg
